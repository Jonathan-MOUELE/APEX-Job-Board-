...
public class FormationsController : ControllerBase
{
    ...
    public IActionResult GetFormations([FromQuery] string sector = "")
    {
        ...
        var all = new Dictionary<string, FormationDto[]>
        {
            ["numerique"] =
            [
                new("🎓", "Google Career Certificates (Data, Cyber, IA)",
                    "https://grow.google/certificates/",
                    "Certification professionnelle Google", "3-6 mois", "Gratuit Coursera / Financé", "#60a5fa"),
                new("☁️", "Microsoft Learn — Azure AZ-900 & SC-900",
                    "https://learn.microsoft.com/fr-fr/credentials/",
                    "Certifications officielles Microsoft", "30-50h", "Cours 100% gratuits + examen", "#38bdf8"),
                new("🌐", "Cisco Networking Academy — CCNA & Cyber",
                    "https://www.netacad.com/fr",
                    "Certification Cisco reconnue mondialement", "3 mois", "Formations gratuites Skills for All", "#06b6d4"),
                new("⚡", "AWS Certified Cloud Practitioner",
                    "https://aws.amazon.com/fr/certification/certified-cloud-practitioner/",
                    "Certification Cloud Amazon", "40h", "100$", "#fb923c"),
                new("🛡️", "ANSSI — SecNumacadémie (Cybersécurité)",
                    "https://secnumacademie.gouv.fr/",
                    "Attestation officielle ANSSI (État Français)", "15h", "100% Gratuit", "#10b981"),
                new("☸️", "Linux Foundation / CNCF — Kubernetes CKA",
                    "https://training.linuxfoundation.org/certification/certified-kubernetes-administrator-cka/",
                    "Certification référence DevOps / Cloud", "3 mois", "Standard mondial", "#6366f1"),
                new("🐍", "Python Institute — PCAP Certified Associate",
                    "https://pythoninstitute.org/pcap",
                    "Certification Python reconnue", "60h", "Examen Pearson VUE", "#facc15"),
                new("🔐", "CompTIA Security+ / Network+",
                    "https://www.comptia.org/certifications/security",
                    "Certification cybersécurité référence", "3 mois", "Standard international", "#f87171"),
            ],
        ...
        else
        {
            ...
            [
                ...
                new("💳", "Mon Compte Formation (CPF)",
                    ...
                    "Catalogue CPF officiel", "Variable", "Droits CPF", "#60a5fa"),
                new("🌐", "Cisco Skills for All — Réseau, Python & Cyber",
                    "https://skillsforall.com/",
                    "Certifications gratuites Cisco", "Variable", "100% Gratuit", "#06b6d4"),
                new("☁️", "Microsoft Learn — Certifications Officielles",
                    "https://learn.microsoft.com/fr-fr/credentials/",
                    "Formations et parcours Microsoft", "Variable", "Cours gratuits", "#38bdf8"),
                new("🎓", "Google Career Certificates & Cloud",
                    "https://grow.google/certificates/",
                    "Certifications professionnelles Google", "3-6 mois", "Gratuit Coursera / Financé", "#4ade80"),
            ];
        }
