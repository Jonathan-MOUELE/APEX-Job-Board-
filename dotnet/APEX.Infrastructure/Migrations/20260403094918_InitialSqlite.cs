        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyLogoUrl = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    ...
                    ContractType = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    ExperienceRequired = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    SalaryLabel = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ...
                    ApplyUrl = table.Column<string>(type: "TEXT", maxLength: 1024, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmTokenExpiry = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JobOfferId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    JobTitle = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    Title = table.Column<string>(type: "TEXT", maxLength: 512, nullable: false),
                    Company = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    Location = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    JobOfferId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                    Column = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    UserId = table.Column<int>(type: "INTEGER", nullable: false),
                    Keywords = table.Column<string>(type: "TEXT", maxLength: 256, nullable: false),
                    Location = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    ContractType = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoftSkillsJson = table.Column<string>(type: "TEXT", nullable: false),
                    CvFileName = table.Column<string>(type: "TEXT", maxLength: 256, nullable: true),
                    CvUploadedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
